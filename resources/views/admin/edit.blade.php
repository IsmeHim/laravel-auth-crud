<x-layouts.app :title="__('Admin Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <h1 class="text-green-500 text-2xl">Edit post</h1>
        <!-- ฟอร์ม Create Post -->
        <form action="{{ route('admin.post.update', $post) }}" method="POST" class="bg-white dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            @method('PUT')
            <!-- Title -->
            <div class="mb-4">
